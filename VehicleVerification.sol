...
contract VehicleVerification is Ownable {
    ...
    // Adding recodes by mecahnic
    function addMechanicData(bytes32 _vin, bytes32 _shopId , bytes32 _shopName, bytes32 _shopAddress ,bytes32 _carDetail , bytes32 _workDescription, bytes32 _moneyCharged, bytes32 _typeOfWork, uint256 _issuedDate, bytes32 _additionalDetail) public  returns (bytes32) {
    ...
    // Adding recordes by DMV
    function addMotorDeptData(bytes32 _vin, bytes32 _ownerName, bytes32 _regId, bytes32 _milesOnCar, bytes32 _modelDetail, bytes32 _numberPlate, bytes32 _motorDeptCity, bytes32 _motorDeptAddress, uint256 _issuedDate, bytes32 _additionalDetail) public  returns (bytes32) {
    ...
    // Adding records by showroom people
    function addShowroomData( bytes32 _vin, bytes32 _ownerDetail, bytes32 _modelDetail, bytes32 _carCost, bytes32 _carLoanOrBankDetail, bytes32 _showroomName, bytes32 _showroomAddress, bytes32 _showroomId, uint256 _issuedDate, bytes32 _additionalDetail) public  returns (bytes32) {
    ...
    // Adding data by vehical inshurance people
    function addInsuranceData(bytes32 _vin, bytes32 _insuranceNumber, bytes32 _numOfInsurance, bytes32 _insuranceDetail , bytes32 _insuranceId , bytes32 _insuranceCompanyName, bytes32 _insuranceCompanyAddress , uint256 _issuedDate, bytes32 _additionalDetail) public  returns (bytes32) {
    ...
    // this funtion is used by the client app to get the records
